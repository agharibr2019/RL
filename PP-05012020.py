...
#print("pcap_1", pcap_1)
#print("pcap_2", pcap_2)
discounted_rewards_1=0
discounted_rewards_2=0
...
for t in range(0,T):
    ...
    for ts in range (t+1,T+1):
        s=s+1
        print("s",s)
        start.append(s)
        Start=np.array(start)
        d=0
        for Ta in range (1,T-ts+2):
            d+=1
            print("d",d)
            duration.append(d)
    ...
    for k in range(0,t_step-1):
        print("k",k)
        for l in range (k+1,t_step):
            print("l",l)
            for r in range(1,M-l+2):
                print("r",r)
                if t_step==l+r:
                    pcap_1=pcap_1+Parking1_occ[k,l,r]
                    pcap_2=pcap_2+Parking2_occ[k,l,r]
                    print("pcap_11:",pcap_1)
                    print("pcap_22:",pcap_2)
    #print("pcap_22:",pcap_2)
...
#### Parking rewards at time t:
    ...
    pw = pw + 1
    print("reward_1",reward_1)
    discounted_rewards_1=reward_1+discounted_rewards_1
    Discounted_rewards_1.append(discounted_rewards_1)
    print("discounted_rewards_1",discounted_rewards_1)
    print("Discounted_rewards_1:",Discounted_rewards_1)
    ...
    pw = pw + 1
    discounted_rewards_2=reward_2+discounted_rewards_2
    Discounted_rewards_2.append(discounted_rewards_2)
...
plt.plot(iter,Discounted_rewards_1)
...
plt.figure(figsize = (8, 4))
plt.plot(iter,Discounted_rewards_2)
plt.xlabel("Decision Epoch")
plt.ylabel("Reward")
plt.title("Reward_p2")
plt.show()
